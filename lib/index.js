...
module.exports = version => {
  const cccData = ucd.readFileSync(path.join(__dirname, '/../UCD/', version, 'extracted/DerivedCombiningClass.txt'))
  const eawData = ucd.readFileSync(path.join(__dirname, '/../UCD/', version, 'EastAsianWidth.txt'))
  const gcData = ucd.readFileSync(path.join(__dirname, '/../UCD/', version, 'extracted/DerivedGeneralCategory.txt'))
  const npData = ucd.readFileSync(path.join(__dirname, '/../UCD/', version, 'DerivedNormalizationProps.txt'))
